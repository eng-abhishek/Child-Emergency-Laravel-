            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Add New School Detail Level One</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" id="salse-man-store" action="{{url('post-add-school-detail-level-one')}}">                 
                  <div class="box-body">
                    ...
                    @enderror
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="school_addreass" id="school_addreass" required="">
                    ...
                    @csrf
                     ...
                     <label for="al_to"><b>Child`s Transportation</b></label>
                      ...
                      <input type="text" class="form-control" name="tr_bus_no" id="tr_bus_no" required="">
                      ...
                      <input type="text" class="form-control" name="tr_bus_stop_location" id="tr_bus_stop_location" required="">
                      ...
                      <input type="text" class="form-control" name="tr_bus_pickup_time" id="tr_bus_pickup_time" required="">
                      ...
                      <input type="text" class="form-control" name="tr_bus_drop_time" id="tr_bus_drop_time" required="">
                      ...
                      <input type="text" class="form-control" name="tr_special_trans_arrangement" id="tr_special_trans_arrangement" required="">
                      ...
                      <input type="text" class="form-control" name="tr_transportation_phone_no" id="tr_transportation_phone_no" required="">
                      ...
                      <input type="text" class="form-control" name="stu_grade" id="stu_grade" required="">
                      @error('stu_grade')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      <input type="text" class="form-control" name="stu_id_no" id="stu_id_no" required="">
                      @error('stu_id_no')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      <input type="text" class="form-control" name="stu_lunch_pin" id="stu_lunch_pin" required="">
                      @error('stu_lunch_pin')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
