    ...
    <!--       <div class="col-md-1"></div> -->
            ...
            @endif
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                 <form role="form" method="post" id="salse-man-store" action="{{url('post-update-child')}}" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    @enderror
                      ...
                      <input type="text" class="form-control" name="name" value="{{$editData->name}}" id="name" value="{{$editData->name}}" required="">
                      @error('name')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                     </div>
                      ...
                      <input type="text" class="form-control" value="{{$editData->nick_name}}" name="nick_name" id="nick_name" required="">
                      @error('nick_name')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                     ...
                     <input type="text" id="dob" name="dob" value="{{$editData->dob}}" class="form-control" required="">
                      @error('dob')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      if($editData->photos){
                      ?>
                      <img src="{{$editData->photos}}" width="50px" style="border-radius:50%">
                      <input type="text" hidden name="OldImg" value="{{$editData->photos}}"> 
                      <?php
                      }else{
                      ?>
                      <?php
