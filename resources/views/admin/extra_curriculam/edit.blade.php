...
@section('title','Edit Extra Curricular Detail')
@section('content')
      ...
      @if ($errors->any())
        ...
        <section class="content-header">
          <h1>
             Admin 
            <small>Edit Extra Curricular Detail</small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Edit Extra Curricular Detail</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                 <form role="form" method="post" id="salse-man-store" action="{{url('post-update-extra-curricular')}}" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    @enderror
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="activity" id="activity" value="{{$editData->activity}}" required="">
                      @error('activity')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                     </div>
                      ...
                      <input type="date" class="form-control" value="{{$editData->days}}" name="days" id="days" required="">
                      @error('days')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      <input type="text" class="form-control" value="{{$editData->start_time}}" name="start_time" id="start_time">
                      @error('start_time')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      <input type="text" value="{{$editData->end_time}}" class="form-control" name="end_time" id="end_time">
                      @error('end_time')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      <input type="text" value="{{$editData->location}}" class="form-control" name="location" id="location">
                      @error('location')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      <input type="text" class="form-control" value="{{$editData->other_information}}" value="{{$editData->other_information}}" name="take_coach_or_leader" id="take_coach_or_leader">
                      ...
                      <input type="text" class="form-control" name="other_information" id="other_information" value="{{$editData->other_information}}">
