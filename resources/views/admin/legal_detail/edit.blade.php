...
@section('title','Edit Legal Detail')
@section('content')
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Edit Legal Detail</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                 <form role="form" method="post" id="salse-man-store" action="{{url('post-update-legal-details')}}" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    @enderror
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="poa_representative_name" id="poa_representative_name" value="{{$editData->poa_representative_name}}">
                      ...
                      <input type="text" class="form-control" name="for_which_child" id="for_which_child" value="{{$editData->for_which_child}}">
                      ...
                      @if($editData->attach_poa_file)
                      <input type="text" value="{{$editData->attach_poa_file}}" name="OLDattach_poa_file" hidden="">
                      <p><a target="_blank" href="{{$editData->attach_poa_file}}">Click to view</a></p>
                      @else
                      @endif
                      @error('likes')
                      <div class="validate_err">{{ $message }}</div>
                      ...
                      <input type="text" class="form-control" name="standby_guardian_name" id="standby_guardian_name" value="{{$editData->standby_guardian_name}}">
                      ...
                      <input type="text" class="form-control" name="standby_alternet_guardian_name" value="{{$editData->standby_alternet_guardian_name}}" id="standby_alternet_guardian_name">
                      ...
                      <input type="text" class="form-control" value="{{$editData->standby_for_which_child}}" name="standby_for_which_child" id="standby_for_which_child">
                      ...
                      @if($editData->standby_attach_gua_file)
                      <input type="text" name="OLDstandby_attach_gua_file" value="{{$editData->standby_attach_gua_file}}" hidden="">
                      <p><a href="{{$editData->standby_attach_gua_file}}" target="_blank">Click to view</a></p>
                      @else
                      @endif
                      ...
                      <input type="text" class="form-control" name="standby_has_paternity_been_established" value="{{$editData->standby_has_paternity_been_established}}" id="standby_has_paternity_been_established">
                      ...
                      <input type="text" class="form-control" name="is_there_currently_a_custody_order_in_place" value="{{$editData->is_there_currently_a_custody_order_in_place}}" id="is_there_currently_a_custody_order_in_place">
                      ...
                      <input type="text" class="form-control" name="what_are_the_current_custody_arrangements" value="{{$editData->what_are_the_current_custody_arrangements}}" id="what_are_the_current_custody_arrangements">
                      ...
                      <input type="text" class="form-control" name="is_there_a_current_active_custody_case" value="{{$editData->is_there_a_current_active_custody_case}}" id="is_there_a_current_active_custody_case">
                      ...
                      <input type="text" class="form-control" value="{{$editData->case_or_docket_number}}" name="case_or_docket_number" id="case_or_docket_number">
