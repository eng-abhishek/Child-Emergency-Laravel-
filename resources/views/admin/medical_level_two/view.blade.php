            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Add Medical Level Two</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" id="salse-man-store" action="{{url('post-add-medical-level-two')}}" enctype="multipart/form-data">                 
                  <div class="box-body">
                   ...
                   <div class="form-group">
                    ...
                    @enderror
                     ...
                     <label for="al_to"><b>Medication </b></label>
                      ...
                      <input type="text" class="form-control" name="medication_name" id="medication_name" required="">
                      ...
                      <input type="text" class="form-control" name="me_reason_for_taking" id="me_reason_for_taking" required="">
                      ...
                      <input type="text" class="form-control" name="me_dose" id="me_dose" required="">
                      @error('me_dose')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      <input type="text" class="form-control" name="me_frequency" id="me_frequency">
                      @error('me_frequency')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      <input type="text" class="form-control" name="me_start_date" id="me_start_date">
                      @error('me_start_date')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      <input type="text" class="form-control" name="me_end_date" id="me_end_date">
                      @error('me_end_date')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      <input type="text" class="form-control" name="me_doctor_name" id="me_doctor_name">
                      ...
                      <input type="text" class="form-control" name="me_note" id="me_note">
                      @error('me_note')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                     ...
                     <label for="al_to"><b>Surgery</b></label>
                      ...
                      <input type="text" class="form-control" name="surgery_or_procedure" id="surgery_or_procedure">
                      ...
                      <input type="text" class="form-control" name="sr_date" id="sr_date">
                      @error('sr_date')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      <input type="text" class="form-control" name="sr_physician" id="sr_physician">
                      @error('sr_physician')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      <input type="text" class="form-control" name="sr_hospital" id="sr_hospital">
                      @error('sr_hospital')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      <input type="text" class="form-control" name="sr_note" id="sr_note">
                      @error('sr_note')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                     ...
                     <label for="al_to"><b>Major Illness</b></label>
                      ...
                      <input type="text" class="form-control" name="illness_start" id="illness_start">
                      @error('illness_start')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
                      ...
                      <input type="text" class="form-control" name="illness_end_date" id="illness_end_date">
                      ...
                      <input type="text" class="form-control" name="illness_treatment_note" id="illness_treatment_note">
