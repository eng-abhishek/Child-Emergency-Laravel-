...
@section('title','Add Care Provider')
@section('content')
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Add New Care Provider</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" id="salse-man-store" action="{{url('post-add-care-provider')}}">                 
                  <div class="box-body">
                    ...
                    @enderror
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="child_care_provider_name" id="child_care_provider_name" required="">
                    ...
                    @csrf
                      ...
                      <input type="text" class="form-control" name="name_of_child_care_center" id="name_of_child_care_center" required="">
                      ...
                      <textarea type="text" class="form-control" name="notes" id="notes" required=""></textarea>
                      @error('notes')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                      </div>
