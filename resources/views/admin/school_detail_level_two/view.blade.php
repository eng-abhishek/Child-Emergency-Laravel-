...
@section('title','Add School Detail Level Two')
@section('content')
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Add School Detail Level Two</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" id="salse-man-store" action="{{url('post-add-school-detail-level-two')}}">                 
                  <div class="box-body">
                    ...
                    @enderror
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="classroom_no" id="classroom_no" required="">
                      @error('classroom_no')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                     </div>
                     ...
                     <label for="al_to"><b>Child`s Tutors</b></label>
                      ...
                      <input type="text" class="form-control" name="tutors_name" id="tutors_name" >
                      @error('tutors_name')
                      <div class="validate_err">{{ $message }}</div>
                      @enderror
                     </div>
                      ...
                      <input type="text" class="form-control" name="details_about_sub_day_time" id="details_about_sub_day_time" >
                     ...
                     <label for="al_to"><b>Individual Education Plan</b></label>
                      ...
                      <input type="text" class="form-control" name="ind_edu_plan_child_dev_challange" id="ind_edu_plan_child_dev_challange" >
                      ...
                      <input type="text" class="form-control" name="ind_edu_plan_date_last_meeting" id="ind_edu_plan_date_last_meeting" >
                      ...
                      <input type="text" class="form-control" name="ind_edu_plan_special_service" id="ind_edu_plan_special_service" >
                      ...
                      <input type="text" class="form-control" name="ind_edu_plan_child_receive_ssi" id="ind_edu_plan_child_receive_ssi" >
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="ind_edu_plan_ssi_amount" id="ind_edu_plan_ssi_amount" >
                      ...
                      <input type="text" class="form-control" name="ind_edu_plan_add_information" id="ind_edu_plan_add_information" >
